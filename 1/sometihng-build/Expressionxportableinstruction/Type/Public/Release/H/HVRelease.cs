...
namespace Core
{
    ...
    {
        public static void HVRelease(Expression expression, String value, String lower, String[] array)
        {
            try
            {
                ...
                isEqualCheck = Object.Equals(ExpressionName.EntityInstructionVRelease, oth) is true;
